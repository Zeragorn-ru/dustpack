...
Если лаунчер уже установлен — переходите к следующему разделу.
...
<div style="display: flex; justify-content: center; gap: 30px; flex-wrap: wrap;">
  <div style="text-align: center;">
    <img src="assets/open_add_user_menu.png" alt="Управление аккаунтами" width="500" />
    <p>Меню управления аккаунтами</p>
  </div>
  <div style="text-align: center;">
    <img src="assets/add_user.png" alt="Добавление offline-аккаунта" width="500" />
